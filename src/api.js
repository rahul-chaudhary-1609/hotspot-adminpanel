...
export const toggleHotspotAvailibility = (token, data) => {
	return new Promise(async (resolve, reject) => {
		try {
			let url=new URL(`${baseURL}toggleHotspotAvailibility`);
			const response = await fetch(url, {
				body: JSON.stringify(data.body),
				headers: {
					Authorization: token,
...
export const listRefundHistory = (token, data) => {
	return new Promise(async (resolve, reject) => {
		try {
			let url=new URL(`${baseURL}listRefundHistory`);
			url.search= new URLSearchParams(data.query).toString();
			const response = await fetch(url, {
				headers: {
					Authorization: token,
...
export const getRefundHistoryDetails = (token, data) => {
	return new Promise(async (resolve, reject) => {
		try {
			let url=new URL(`${baseURL}getRefundHistoryDetails`);
			Object.keys(data.params).forEach(key=>url.pathname=`${url.pathname}/${data.params[key]}`)
			const response = await fetch(url, {
				headers: {
					Authorization: token,
...
export const listActiveCustomers = (token, data) => {
	return new Promise(async (resolve, reject) => {
		try {
			let url=new URL(`${baseURL}listActiveCustomers`);
			url.search= new URLSearchParams(data.query).toString();
			const response = await fetch(url, {
				headers: {
					Authorization: token,
...
export const addPromotionalCredits = (token, data) => {
	return new Promise(async (resolve, reject) => {
		try {
			let url=new URL(`${baseURL}addPromotionalCredits`);
			const response = await fetch(url, {
				body: JSON.stringify(data.body),
				headers: {
					Authorization: token,
...
export const editPromotionalCredits = (token, data) => {
	return new Promise(async (resolve, reject) => {
		try {
			let url=new URL(`${baseURL}editPromotionalCredits`);
			const response = await fetch(url, {
				body: JSON.stringify(data.body),
				headers: {
					Authorization: token,
