import { SIGN_IN, SIGN_OUT, EMAIL, ORDER_SEARCH_TEXT,SEARCH_TEXT ,ADMIN_DATA , STATUS, START_DATE_FILTER, END_DATE_FILTER, FILTER_BY, CLEAR_DATA} from '../actions/types';
...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        case SIGN_IN:
            return { ...state, isSignedIn: action.payload.token, userId: action.payload.id };
        case SIGN_OUT:
