  ...
  return (
    <div className='main-content pb-16 md:pb-5 flex-1 pt-20 px-2'>
      <div className="mt-6 lg:mt-0 rounded shadow bg-white">
        <h3 className="text-2xl text-gray-400 font-bold p-4 md:p-6">Privacy Policies</h3>
            ...
            <form action="" className="w-full max-w-full text-gray-300 text-base">
              <div className="flex flex-wrap -mx-3 mb-6">
                <label className="block tracking-wide mb-2" for="tc">
                  Enter your privacy policies
                </label>
                <textarea className="appearance-none block w-full bg-gray-100 border border-gray-100 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white resize-none focus:border-gray-200" id="tc" placeholder="Privacy Policies " rows="15" ></textarea>
              </div>
