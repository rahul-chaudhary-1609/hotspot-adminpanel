...
function SideNavbar() {
	...
	return (
		<div
			style={pathname.split('/')[2]== 7 && pathname.split('/')[1] == 'viewStaticContent'?{ width: '23rem', height: 'calc(150vh - 68px)' }:pathname.split('/')[1] == 'restaurantPayment'?{ width: '23rem', height: 'calc(204vh - 68px)' }:(pathname.split('/')[1] == 'pickupEarning'|| pathname.split('/')[1] == 'hotspotEarning'|| pathname.split('/')[1] == 'feesettings')?{ width: '23rem', height: 'calc(150vh - 68px)' }:pathname.split('/')[1] == 'notification'?{ width: '23rem', height: 'calc(122vh - 68px)' }:{ width: '23rem', height: 'calc(100vh - 68px)' }}
